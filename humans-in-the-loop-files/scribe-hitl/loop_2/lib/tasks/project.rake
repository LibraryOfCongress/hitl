...
namespace :project do
  ...
  task :load, [:project_key, :area] => :environment do |task, args|
    ...
    if project.status == 'active'
      ...
      # FileUtils.cp_r("project/#{project.key}/assets/js", 'public')
      # FileUtils.cp_r("project/#{project.key}/assets/css", 'public')
      # FileUtils.cp_r("project/#{project.key}/assets/images", 'public')
      project.activate!
