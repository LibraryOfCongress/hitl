...
export default class RectangleTool extends React.Component {
  ...
  static initValid(mark, marks) {
    ...
    for (let candidate of marks) {
      ...
      // TODO: Portal: commenting out overlap logic to allow overlapping selections
...
points="${points}" \
stroke-width="${this.props.selected ? SELECTED_STROKE_WIDTH/scale : STROKE_WIDTH/scale }" \
